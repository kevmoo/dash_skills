...
description: |-
  Deprecated. Understand and improve test coverage in a Dart package. Use the
  upstream `dart-collect-coverage` skill instead.
---
# Deprecated Skill: dart-test-coverage
...
the official upstream skill **`dart-collect-coverage`** instead.

Provide the user with the installation instruction:
```bash
npx skills add dart-lang/skills --skill dart-collect-coverage --agent universal
```
